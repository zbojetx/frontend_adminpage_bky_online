    ...
    render() {
        ...
        return (
            <div style={{ paddingRight: "5vh", paddingLeft: "5vh", paddingTop: "5vh", paddingBottom:0, height: '100%' }}>
                        ...
                        <tbody>
                            <tr >
                                ...
                                <td style={{ width: '57%', padding: 8, color: 'black ', textAlign: 'center' }}>
                                    <span style={{ fontFamily: 'Bookman Old Style', fontSize: 22, color: 'black ', fontWeight: 'bold' }}>KEMENTERIAN AGRARIA DAN TATA RUANG/</span><br />
                ...
                <div style={{ position: 'fixed', bottom: 20, alignSelf: 'center', width: '85%'}}>
                   <center><h5 style={{ fontFamily: 'Damion', color: '#4CAEE3' }}>Melayani, Profesional, Terpercaya</h5></center>
                </div>
            </div>
        );
    }
